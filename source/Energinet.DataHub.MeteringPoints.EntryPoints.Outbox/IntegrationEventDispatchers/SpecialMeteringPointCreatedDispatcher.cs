...
{
    public class SpecialMeteringPointCreatedDispatcher : IntegrationEventDispatcher<SpecialMeteringPointCreatedTopic, SpecialMeteringPointCreatedIntegrationEvent>
    {
        public SpecialMeteringPointCreatedDispatcher(
            ITopicSender<SpecialMeteringPointCreatedTopic> topicSender,
            ProtobufOutboundMapper<SpecialMeteringPointCreatedIntegrationEvent> mapper,
        ...
        protected override void EnrichMessage(ServiceBusMessage serviceBusMessage)
        {
            serviceBusMessage.EnrichMetadata(
                nameof(SpecialMeteringPointCreated),
                1);
        }
    }
}
