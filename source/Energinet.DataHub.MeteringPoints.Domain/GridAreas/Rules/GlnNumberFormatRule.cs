...
{
    internal class GlnNumberFormatRule : IBusinessRule
    {
        private const int RequiredIdLength = 13;
        private readonly string? _glnNumber;

        public GlnNumberFormatRule(string glnNumber)
        {
        ...
        public ValidationError ValidationError => new GlnNumberFormatRuleError();
