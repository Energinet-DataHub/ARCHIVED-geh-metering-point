...
namespace Energinet.DataHub.MeteringPoints.Domain.Extensions
{
    public static class MeteringPointTypeStringExtensions
    {
        public static bool IsParent(this string meteringPointType)
        {
