...
namespace Energinet.DataHub.MeteringPoints.Domain.MasterDataHandling.Rules
{
    ...
    {
        public StreetNameIsRequiredRule(Address address)
        {
            if (address == null) throw new ArgumentNullException(nameof(address));
            IsBroken = string.IsNullOrWhiteSpace(address.StreetName);
        }

        public StreetNameIsRequiredRule(string? streetName)
        {
        ...
        public ValidationError ValidationError => new StreetNameIsRequiredRuleError();
    }
}
