...
namespace Energinet.DataHub.MeteringPoints.Domain.MeteringPoints
{
    public class MeteringPointType : EnumerationType
    {
        ...
        public static readonly MeteringPointType ExchangeReactiveEnergy = new MeteringPointType(6, nameof(ExchangeReactiveEnergy), 4);
        ...
        public static readonly MeteringPointType ElectricalHeating = new MeteringPointType(17, nameof(ElectricalHeating), 5);
