...
#pragma warning restore 8618
            ...
            string? parentRelatedMeteringPoint)
        {
            ...
            AddDomainEvent(new MeteringPointCreated(id, GsrnNumber, meteringPointType, gridAreaId, meteringPointSubType, ConnectionState.PhysicalState, meterReadingOccurrence, ProductType.Tariff, unitType, effectiveDate.ToString()!));
        }
