...
{
    public class MeteringPointMustHavePhysicalStateNewRule : IBusinessRule
    {
        private readonly GsrnNumber _gsrnNumber;
        private readonly MeteringPointType _meteringPointType;

        public MeteringPointMustHavePhysicalStateNewRule(GsrnNumber gsrnNumber, MeteringPointType meteringPointType, PhysicalState physicalState)
        {
            _gsrnNumber = gsrnNumber;
            _meteringPointType = meteringPointType;
            IsBroken = physicalState != PhysicalState.New;
        }
