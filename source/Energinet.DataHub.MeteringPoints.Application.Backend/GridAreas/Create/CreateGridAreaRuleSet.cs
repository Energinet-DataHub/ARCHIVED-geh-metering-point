...
using Energinet.DataHub.MeteringPoints.Application.Backend.GridAreas.Create.Validation.Rules;
using Energinet.DataHub.MeteringPoints.Application.Validation.Extensions;
using Energinet.DataHub.MeteringPoints.Domain.GridAreas;
using FluentValidation;

namespace Energinet.DataHub.MeteringPoints.Application.Backend.GridAreas.Create
{
