...
{
    [IntegrationTest]
    public class MeteringPointClientSecurityTests : WebApiHostWithSecurity
    {
        private readonly WebApiFactory _webApiFactory;

        public MeteringPointClientSecurityTests(WebApiFactory webApiFactory, DatabaseFixture databaseFixture)
