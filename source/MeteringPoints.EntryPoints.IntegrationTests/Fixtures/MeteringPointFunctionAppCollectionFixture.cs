...
namespace Energinet.DataHub.MeteringPoints.EntryPoints.IntegrationTests.Fixtures
{
    ...
    /// </summary>
    [CollectionDefinition(nameof(MeteringPointFunctionAppCollectionFixture))]
    public class MeteringPointFunctionAppCollectionFixture : ICollectionFixture<MeteringPointFunctionAppFixture>
    {
    }
}
