...
using Energinet.DataHub.MeteringPoints.Application.MeteringPoints.Create.Consumption.Validation;
...
using ConnectMeteringPoint = Energinet.DataHub.MeteringPoints.Application.MeteringPoints.Connect.ConnectMeteringPoint;
...
namespace Energinet.DataHub.MeteringPoints.EntryPoints.Processing
{
    public class Program : EntryPoint
    {
        ...
        protected override void ConfigureContainer(Container container)
        {
            ...
            container.Register<IValidator<CreateConsumptionMeteringPoint>, RuleSet>(Lifestyle.Scoped);
            container.Register<IValidator<CreateProductionMeteringPoint>, Application.MeteringPoints.Create.Production.Validation.RuleSet>(Lifestyle.Scoped);
            container.Register<IValidator<CreateExchangeMeteringPoint>, Application.MeteringPoints.Create.Exchange.Validation.RuleSet>(Lifestyle.Scoped);
