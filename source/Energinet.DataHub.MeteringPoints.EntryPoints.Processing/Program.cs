...
namespace Energinet.DataHub.MeteringPoints.EntryPoints.Processing
{
    public class Program : EntryPoint
    {
        ...
        protected override void ConfigureContainer(Container container)
        {
            ...
            container.Register<IValidator<CreateConsumptionMeteringPoint>, CreateMeteringPointRuleSet>(Lifestyle.Scoped);
            container.Register<IValidator<ConnectMeteringPoint>, ConnectMeteringPointRuleSet>(Lifestyle.Scoped);
            container.Register(typeof(IBusinessProcessResultHandler<CreateConsumptionMeteringPoint>), typeof(CreateConsumptionMeteringPointResultHandler), Lifestyle.Scoped);
