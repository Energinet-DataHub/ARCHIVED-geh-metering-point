...
namespace Energinet.DataHub.MeteringPoints.Application.Validation.Rules
{
    public class MeteringGridAreaValidRule : AbstractValidator<CreateMeteringPoint>
    {
        ...
        {
            RuleFor_MandatoryMeteringGridArea();
            RuleFor_MeteringGridAreaLengthOf3Digits();
        }

        private void RuleFor_MandatoryMeteringGridArea()
        {
        ...
        private void RuleFor_MeteringGridAreaLengthOf3Digits()
        {
            RuleFor(meteringGridArea => meteringGridArea.MeteringGridArea)
                .Length(3)
