...
{
    public class FutureEnergySupplierChangeRegisteredHandler : INotificationHandler<FutureEnergySupplierChangeRegistered>
    {
        private readonly ICommandScheduler _commandScheduler;

        public FutureEnergySupplierChangeRegisteredHandler(ICommandScheduler commandScheduler)
        {
