...
{
    public class SetFutureEnergySupplierInfo : InternalCommand
    {
        public SetFutureEnergySupplierInfo(string meteringPointGsrn, Instant startOfSupply, string energySupplierGln)
        {
