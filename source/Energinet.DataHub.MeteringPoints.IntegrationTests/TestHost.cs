...
#pragma warning disable CA1724 // TODO: TestHost is reserved. Maybe refactor to base EntryPoint?
    public class TestHost : IDisposable
    {
        ...
        protected TestHost(DatabaseFixture databaseFixture)
        {
            ...
            _container.Register(typeof(IBusinessProcessResultHandler<DisconnectMeteringPointRequest>), typeof(DisconnectMeteringPointResultHandler), Lifestyle.Scoped);
            ...
            _container.Register<IValidator<DisconnectMeteringPointRequest>, DisconnectMeteringPointRuleSet>(Lifestyle.Scoped);
