...
#pragma warning disable CA1724 // TODO: TestHost is reserved. Maybe refactor to base EntryPoint?
    public class TestHost : IDisposable
    {
        ...
        protected TestHost(DatabaseFixture databaseFixture)
        {
            ...
            _container.Register<IValidator<CreateConsumptionMeteringPoint>, RuleSet>(Lifestyle.Scoped);
            ...
            _container.Register<IValidator<CreateExchangeMeteringPoint>, Application.MeteringPoints.Create.Exchange.Validation.RuleSet>(Lifestyle.Scoped);
