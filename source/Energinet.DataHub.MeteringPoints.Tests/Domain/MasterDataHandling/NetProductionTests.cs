...
{
    [UnitTest]
    public class NetProductionTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.NetProduction))
        ...
        {
            return new MasterDataValidator().CheckRulesFor(MeteringPointType.NetProduction, masterData);
        }
    }
}
