...
{
    [UnitTest]
    public class ConsumptionFromGridTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.ConsumptionFromGrid))
        ...
        {
            return new MasterDataValidator().CheckRulesFor(MeteringPointType.ConsumptionFromGrid, masterData);
        }
    }
}
