...
{
    [UnitTest]
    public class NetToGridTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.NetToGrid))
        ...
        {
            return new MasterDataValidator(new NetToGridValidator()).CheckRulesFor(MeteringPointType.NetToGrid, masterData);
        }
    }
}
