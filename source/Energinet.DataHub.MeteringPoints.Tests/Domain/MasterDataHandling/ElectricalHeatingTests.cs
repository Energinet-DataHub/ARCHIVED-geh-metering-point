...
{
    [UnitTest]
    public class ElectricalHeatingTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.ElectricalHeating))
        ...
        {
            return new MasterDataValidator().CheckRulesFor(MeteringPointType.ElectricalHeating, masterData);
        }
    }
}
