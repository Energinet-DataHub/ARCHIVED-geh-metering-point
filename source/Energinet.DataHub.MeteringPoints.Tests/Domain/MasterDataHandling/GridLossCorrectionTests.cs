...
{
    [UnitTest]
    public class GridLossCorrectionTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.GridLossCorrection))
        ...
        {
            return new MasterDataValidator().CheckRulesFor(MeteringPointType.GridLossCorrection, masterData);
        }
    }
}
