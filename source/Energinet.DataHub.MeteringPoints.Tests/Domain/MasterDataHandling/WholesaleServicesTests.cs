...
{
    [UnitTest]
    public class WholesaleServicesTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.WholesaleServices))
        ...
        {
            return new MasterDataValidator().CheckRulesFor(MeteringPointType.WholesaleServices, masterData);
        }
    }
}
