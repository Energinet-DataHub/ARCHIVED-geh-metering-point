...
{
    [UnitTest]
    public class NetFromGridTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.NetFromGrid))
        ...
        {
            return new MasterDataValidator(new NetFromGridValidator()).CheckRulesFor(MeteringPointType.NetFromGrid, masterData);
        }
    }
}
