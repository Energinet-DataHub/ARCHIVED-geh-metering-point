...
{
    [UnitTest]
    public class OtherProductionTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.OtherProduction))
        ...
        {
            return new MasterDataValidator().CheckRulesFor(MeteringPointType.OtherProduction, masterData);
        }
    }
}
