...
{
    [UnitTest]
    public class OwnProductionTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.OwnProduction))
        ...
        {
            return new MasterDataValidator().CheckRulesFor(MeteringPointType.OwnProduction, masterData);
        }
    }
}
