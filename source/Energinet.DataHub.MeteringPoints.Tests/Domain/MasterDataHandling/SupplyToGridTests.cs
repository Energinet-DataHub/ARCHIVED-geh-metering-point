...
{
    [UnitTest]
    public class SupplyToGridTests : TestBase
    {
        [Fact]
        ...
        private static IMasterDataBuilder Builder() =>
            new MasterDataBuilder(new MasterDataFieldSelector().GetMasterDataFieldsFor(MeteringPointType.SupplyToGrid))
        ...
        {
            return new MasterDataValidator().CheckRulesFor(MeteringPointType.SupplyToGrid, masterData);
        }
    }
}
