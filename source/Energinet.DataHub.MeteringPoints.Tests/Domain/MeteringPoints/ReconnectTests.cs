...
{
    public class ReconnectTests : TestBase
    {
        ...
        [Fact]
        public void Metering_point_must_be_Disconnected()
        {
            ...
            AssertError<PhysicalStateMustBeConnectedOrDisconnectedError>(meteringPoint.ReconnectAcceptable(connectionDetails));
        }
        ...
        public void Should_succeed()
        {
            ...
            meteringPoint.Reconnect(connectionDetails);

            Assert.Equal(meteringPoint.ConnectionState.PhysicalState, PhysicalState.Connected);
            Assert.Contains(meteringPoint.DomainEvents, evt => evt is MeteringPointReconnected);
        }
