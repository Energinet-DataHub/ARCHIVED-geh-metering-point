...
namespace Energinet.DataHub.MeteringPoints.Infrastructure.DataAccess.MeteringPoints.Queries
{
    public class MeteringPointByGsrnQueryHandler : IRequestHandler<MeteringPointByGsrnQuery, MeteringPointCimDto?>
    {
        ...
        private static MeteringPointCimDto MapToCimDto(MeteringPointDto meteringPointDto)
        {
            ...
            var productId = ConvertEnumerationTypeToEnum<ProductId, Energinet.DataHub.MeteringPoints.Domain.MeteringPoints.ProductType>(meteringPointDto.Product);

            return new MeteringPointCimDto
            {
                MeteringPointId = meteringPointDto.MeteringPointId,
                GsrnNumber = meteringPointDto.GsrnNumber,
                StreetName = meteringPointDto.StreetName,
                PostalCode = meteringPointDto.PostCode,
                CityName = meteringPointDto.CityName,
                CountryCode = meteringPointDto.CountryCode,
                ConnectionState = connectionState,
                MeteringMethod = meteringPointSubType,
                ReadingOccurrence = readingOccurrence,
                MeteringPointType = meteringPointType,
                RatedCapacity = meteringPointDto.MaximumCurrent,
                RatedCurrent = meteringPointDto.MaximumPower,
                GridAreaName = meteringPointDto.GridAreaName,
                GridAreaCode = meteringPointDto.GridAreaCode,
                PowerPlantGsrnNumber = meteringPointDto.PowerPlantGsrnNumber,
                LocationDescription = meteringPointDto.LocationDescription,
                ProductId = productId,
                Unit = unitType,
                EffectiveDate = meteringPointDto.EffectiveDate.ToDateTimeUtc(),
                MeterId = meteringPointDto.MeterNumber,
                StreetCode = meteringPointDto.StreetCode,
                CitySubDivisionName = meteringPointDto.CitySubDivisionName,
                FloorIdentification = meteringPointDto.Floor,
                SuiteNumber = meteringPointDto.Suite,
                BuildingNumber = meteringPointDto.BuildingNumber,
                MunicipalityCode = meteringPointDto.MunicipalityCode,
                IsActualAddress = meteringPointDto.IsActualAddress,
                DarReference = meteringPointDto.GeoInfoReference,
                Capacity = meteringPointDto.Capacity,
                AssetType = assetType,
                SettlementMethod = settlementMethod,
                InAreaCode = meteringPointDto.ToGridAreaCode,
                OutAreaCode = meteringPointDto.FromGridAreaCode,
                NetSettlementGroup = netSettlementGroup,
                SupplyStart = meteringPointDto.SupplyStart,
                ConnectionType = connectionType,
                DisconnectionType = disconnectionType,
                ProductionObligation = meteringPointDto.ProductionObligation,
                ChildMeteringPoints = new List<MeteringPointSimpleCimDto>(),
                ParentMeteringPoint = null,
                LinkedExtendedMasterdata = null,
            };
        }
