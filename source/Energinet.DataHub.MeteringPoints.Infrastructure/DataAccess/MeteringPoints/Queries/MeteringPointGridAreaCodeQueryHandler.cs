...
{
    public class MeteringPointGridAreaCodeQueryHandler : IRequestHandler<MeteringPointGridAreaCodeQuery, int>
    {
        private readonly IDbConnectionFactory _connectionFactory;

        public MeteringPointGridAreaCodeQueryHandler(IDbConnectionFactory connectionFactory)
        {
            _connectionFactory = connectionFactory;
        }

        public async Task<int> Handle(MeteringPointGridAreaCodeQuery request, CancellationToken cancellationToken)
        {
            ...
            var result = await _connectionFactory
                .GetOpenConnection()
                .ExecuteScalarAsync<int?>(sql, new { request.GridAreaLinkId })
