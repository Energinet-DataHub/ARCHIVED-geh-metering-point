...
namespace Energinet.DataHub.MeteringPoints.Infrastructure.ContainerExtensions.ChainOfResponsibility
{
    ...
    {
        protected CoRDependencyInjectionException()
        {
        }

        protected CoRDependencyInjectionException(string message)
            : base(message)
        {
        }

        protected CoRDependencyInjectionException(string message, Exception innerException)
