...
{
    public class PhysicalStateMustBeDisconnectedErrorConverter : ErrorConverter<PhysicalStateMustBeDisconnectedError>
    {
        protected override ErrorMessage Convert(PhysicalStateMustBeDisconnectedError validationError)
        {
