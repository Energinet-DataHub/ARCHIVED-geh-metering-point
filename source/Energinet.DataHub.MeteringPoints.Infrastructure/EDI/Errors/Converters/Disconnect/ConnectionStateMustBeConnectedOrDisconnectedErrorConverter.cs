...
{
    public class ConnectionStateMustBeConnectedOrDisconnectedErrorConverter : ErrorConverter<ConnectionStateMustBeConnectedOrDisconnectedError>
    {
        protected override ErrorMessage Convert(ConnectionStateMustBeConnectedOrDisconnectedError validationError)
        {
