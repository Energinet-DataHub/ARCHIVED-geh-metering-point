...
{
    public class ParentMustBeMarketMeteringPointConditionalRuleErrorConverter : ErrorConverter<ParentMustBeMarketMeteringPointConditionalRuleError>
    {
        protected override ErrorMessage Convert(ParentMustBeMarketMeteringPointConditionalRuleError validationError)
        {
