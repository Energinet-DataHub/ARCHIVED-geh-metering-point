...
{
    public class InvalidSettlementMethodRuleErrorConverter : ErrorConverter<InvalidSettlementMethodRuleError>
    {
        protected override ErrorMessage Convert(InvalidSettlementMethodRuleError validationError)
        {
