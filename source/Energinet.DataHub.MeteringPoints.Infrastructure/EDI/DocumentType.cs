...
namespace Energinet.DataHub.MeteringPoints.Infrastructure.EDI
{
    public sealed class DocumentType : EnumerationType
    {
        ...
        public static readonly DocumentType ConfirmConnectionStatusMeteringPoint = new(9, nameof(ConfirmConnectionStatusMeteringPoint), typeof(ConfirmMessage));
        public static readonly DocumentType RejectConnectionStatusMeteringPoint = new(10, nameof(RejectConnectionStatusMeteringPoint), typeof(RejectMessage));
        public static readonly DocumentType AcceptCloseDownRequest = new(13, nameof(AcceptCloseDownRequest), typeof(ConfirmMessage));
        public static readonly DocumentType RejectCloseDownRequest = new(14, nameof(RejectCloseDownRequest), typeof(RejectMessage));
