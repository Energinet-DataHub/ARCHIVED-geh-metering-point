...
{
    public class OnSpecialMeteringPointCreated : IntegrationEventPublisher<SpecialMeteringPointCreated>
    {
        private readonly DbGridAreaHelper _dbGridAreaHelper;

        public OnSpecialMeteringPointCreated(
            IOutbox outbox,
            IOutboxMessageFactory outboxMessageFactory,
            DbGridAreaHelper dbGridAreaHelper)
