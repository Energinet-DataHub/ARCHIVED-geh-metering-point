...
{
    public class
        MasterDataRequestResponseOutBoundMapper : ProtobufOutboundMapper<Application.RequestMasterData.MasterData>
    {
        protected override IMessage Convert(Application.RequestMasterData.MasterData obj)
        {
            ...
            return new MeteringPointMasterDataResponse
            {
                MasterData = new RequestResponse.Response.MasterData()
                {
                    ...
                    Series = new Series { Product = obj.Series.Product, UnitType = obj.Series.UnitType, },
                    GridAreaDetails =
                        new GridAreaDetails
                        {
