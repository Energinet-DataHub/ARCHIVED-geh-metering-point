...
{
    public class EDIMessagingBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
...

    {
        ...
        public EDIMessagingBehaviour(IBusinessProcessResponder<TRequest> businessProcessResponder)
        {
            ...
            RequestHandlerDelegate<TResponse> next)
        {
            ...
            await _businessProcessResponder.RespondAsync(request, result);
            return result;
        }
    }
}